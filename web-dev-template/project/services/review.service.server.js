module.exports = function (app, models) {
    ...
    app.post('/mc/user/:uid/movie/:mid', addReview);
    app.get('/mc/movie/:mid/reviews', findAllReviewsForMovieId);
    app.get('/mc/user/:uid/reviews', findAllReviewsForUserId);
    app.put('/mc/review/:rid', updateReview);
    app.delete('/mc/review/:rid', deleteReview);
